...
<html>
    <head>
		...
		<meta http-equiv="Refresh" content="1;url='staff.html'" />
	...
	try
	{
		...
		ResultSet rs = st.executeQuery("select * from staff where u_name='"+uname+"' ");
		
				
		if (rs.next() == false) {
			
			st.executeUpdate("insert into staff(name,u_name,password)values('"+name+"','"+uname+"','"+pass+"')");
